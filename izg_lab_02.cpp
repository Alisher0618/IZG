...
void rasterizeLine(int x1, int y1, int x2, int y2, S_RGBA color)
{
    ...
    if (dx != 0) {
        ...
        setPixelColor(x1, y1 >> FRAC_BITS, color);
    }
}
...
void put8PixelsOfCircle(int x, int y, int sx, int sy, S_RGBA color)
{
     ...
     */
    int coordplus = 1, coordminus = -1;

    setPixelColor(coordminus * y + sx, coordminus * x + sy, color);
    setPixelColor(coordminus * x + sx, coordminus * y + sy, color);

    setPixelColor(coordminus * y + sx, coordplus * x + sy, color);
    setPixelColor(coordminus * x + sx, coordplus * y + sy, color);

    setPixelColor(coordplus * y + sx, coordplus * x + sy, color);
    setPixelColor(coordplus * x + sx, coordplus * y + sy, color);

    setPixelColor(coordplus * y + sx, coordminus * x + sy, color);
    setPixelColor(coordplus * x + sx, coordminus * y + sy, color);
